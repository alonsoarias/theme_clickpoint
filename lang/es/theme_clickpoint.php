...
$string['footertextdesc'] = 'El contenido a mostrar en la sección central del área del pie de página.';

$string['footertitle2'] = 'Título del pie de página derecho';
$string['footertitledesc2'] = 'El título para la sección derecha en el área del pie de página.';
...
$string['customcssdesc'] = 'Agregue reglas CSS personalizadas para ajustar la apariencia de su tema ClickPoint. Estas reglas se aplicarán en todas las páginas.';
...
$string['config_copypaste_desc'] = 'Cuando está habilitado, impide que los usuarios con roles seleccionados copien o peguen contenido.';
...
$string['enablecarousel'] = 'Habilitar carrusel en página de inicio';
$string['enablecarousel_desc'] = 'Activa la función de carrusel de imágenes en la página de inicio de sesión.';
